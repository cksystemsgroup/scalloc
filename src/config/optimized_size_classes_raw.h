...
#define SIZE_CLASSES \
  ...
  SIZE_CLASS(18, 1024, ((64 * 1024 + sizeof(SpanHeader))/kPageSize + 1) * kPageSize, 64) /* NOLINT */ \
  SIZE_CLASS(19, 2048, ((64 * 2048 + sizeof(SpanHeader))/kPageSize + 1) * kPageSize, 64) /* NOLINT */ \
  SIZE_CLASS(20, 4096, ((32 * 4096 + sizeof(SpanHeader))/kPageSize + 1) * kPageSize, 32) /* NOLINT */ \
  SIZE_CLASS(21, 8192, ((32 * 8192 + sizeof(SpanHeader))/kPageSize + 1) * kPageSize, 32) /* NOLINT */ \
  SIZE_CLASS(22, 16384, ((16 * 16384 + sizeof(SpanHeader))/kPageSize + 1) * kPageSize, 16) /* NOLINT */ \
